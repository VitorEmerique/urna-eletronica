...
public class CreateTables {
        public static void createTables() {
                ...
                try {
                        ...
                        statement.execute(
                                        "CREATE TABLE IF NOT EXISTS cargo ( id INTEGER not NULL PRIMARY KEY, nome VARCHAR unique )");
                        statement.execute(
                        ...
                        statement.execute(
                                        "CREATE TABLE IF NOT EXISTS eleicao ( id INTEGER not NULL PRIMARY KEY, nome VARCHAR unique, data VARCHAR)");
